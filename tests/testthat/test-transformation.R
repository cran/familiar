        ...
        if(transformation_method == "none"){
          ...
          for(feature in familiar:::get_feature_columns(data_copy)){
            ...
            if(feature_info_list[[feature]]@feature_type == "numeric"){
              ...
              # For categorical features test that the
              # none method is used.
              testthat::expect_equal(
                is(feature_info_list[[feature]]@transformation_parameters, "featureInfoParametersTransformationNone"),
                TRUE)
          ...
          for(feature in familiar:::get_feature_columns(data_copy)){
            ...
            if(feature_info_list[[feature]]@feature_type == "numeric"){
              ...
              if(feature == "feature_2"){
                # Expect that for the NA feature, the
                # none method is used.
                testthat::expect_equal(
                  is(feature_info_list[[feature]]@transformation_parameters, "featureInfoParametersTransformationNone"),
                  TRUE)
        ...
        n_numeric_features, " numeric features for a dataset with invariant features."),
      {
        ...
        if(transformation_method == "none"){
          ...
          for(feature in familiar:::get_feature_columns(data_copy)){
            ...
            # Determine if the feature is numeric.
            if(feature_info_list[[feature]]@feature_type == "numeric"){
              # Check the none method is used for invariant
              # features.
              testthat::expect_equal(
                is(feature_info_list[[feature]]@transformation_parameters, "featureInfoParametersTransformationNone"),
                TRUE)
        ...
        if(transformation_method == "none"){
          ...
          for(feature in familiar:::get_feature_columns(data_copy)){
            ...
            if(feature_info_list[[feature]]@feature_type == "numeric"){
              ...
              if(feature == "feature_2"){
                # Expect that the invariant feature uses the
                # none method.
                testthat::expect_equal(
                  is(feature_info_list[[feature]]@transformation_parameters, "featureInfoParametersTransformationNone"),
                  TRUE)
        ...
        if(transformation_method == "none"){
          ...
          for(feature in familiar:::get_feature_columns(data_copy)){
            ...
            if(feature_info_list[[feature]]@feature_type == "numeric"){
              ...
              # Expect that the none-method is used for
              # one-sample data.
              testthat::expect_equal(
                is(feature_info_list[[feature]]@transformation_parameters, "featureInfoParametersTransformationNone"),
                TRUE)
...
testthat::test_that(
  paste0("Transformation is correctly performed when mixing transformation methods."),
  {
    ...
    testthat::expect_equal(
      is(feature_info_list$feature_1@transformation_parameters, "featureInfoParametersTransformationBoxCox"),
      TRUE)
    testthat::expect_equal(
      is(feature_info_list$feature_2@transformation_parameters,  "featureInfoParametersTransformationBoxCox"),
      TRUE)
    ...
    testthat::expect_equal(
      ...
      TRUE)
    testthat::expect_equal(
      is(feature_info_list$feature_3@transformation_parameters, "featureInfoParametersTransformationYeoJohnson"),
      TRUE)
    testthat::expect_equal(
      is.null(feature_info_list$feature_4@transformation_parameters),
      TRUE)
    ...
    testthat::expect_equal(
      ...
      TRUE)
    testthat::expect_equal(
      is(feature_info_list$feature_4@transformation_parameters, "featureInfoParametersTransformationNone"),
      TRUE)
