...
for(outcome_type in c("binomial", "multinomial", "continuous", "count", "survival")){
  ...
  for(stratify in available_stratify_options){
    ...
    testthat::test_that(paste0("Subsampling ", ifelse(stratify, "(stratified) ", ""),
                               "for ", outcome_type, " functions correctly."), {
                                 ...
                                 for(ii in seq_along(subsample_data$train_list)){
                                   ...
                                   # Check that the combination of in-bag and
                                   # out-of-bag data is the same as the input
                                   # dataset.
                                   ...
                                   # identical to the development dataset.
                                   ...
                                   # Test that the subsample has the required
                                   # size.
                                   testthat::expect_equal(data.table::uniqueN(train_data@data, by=c("batch_id", "sample_id")), 20)

                                   # Check that sampling creates a dataset
                                   # identical to the validation dataset.
