...
data_2 <- familiar:::test_create_synthetic_correlated_data(outcome_type="continuous",
                                                         n_numeric=2,
                                                         cluster_size=c(1, 1, 4, 2))

vimp_object_2 <- familiar:::prepare_vimp_object(data=data_2,
                                                vimp_method="pearson",
                                                outcome_type="continuous",
                                                transformation_method="none",
                                                normalisation_method="none",
...
updated_vimp_table_object <- familiar:::update_vimp_table_to_reference(vimp_table_object,
...
data_3 <- familiar:::test_create_synthetic_correlated_data(outcome_type="continuous",
                                                           n_numeric=2,
...
vimp_object_3 <- familiar:::prepare_vimp_object(data=data_3,
                                                vimp_method="pearson",
                                                outcome_type="continuous",
                                                transformation_method="none",
                                                normalisation_method="none",
...
# Update the variable importance object using the reference cluster table.
updated_vimp_table_object <- familiar:::update_vimp_table_to_reference(empty_vimp_table_object,
                                                                       reference_cluster_table)
