    ...
    testthat::test_that(paste0("Batch normalisation is correctly performed using the ",
                               ...
                               n_numeric_features, " numeric features."),
                        {
                          ...
                          if(batch_normalisation_method %in% familiar:::.get_available_batch_normalisation_methods("combat")){
                            ...
                            feature_info_list <- familiar:::create_normalisation_parameter_skeleton(feature_info_list=feature_info_list,
                                                                                                    normalisation_method="standardisation")
                            
                            # Update the feature info list with global
                          ...
                          feature_info_list <- familiar:::create_batch_normalisation_parameter_skeleton(feature_info_list=feature_info_list,
                          ...
                          data_copy <- familiar:::batch_normalise_features(data=data_copy,
                                                                           feature_info_list=feature_info_list)
                            ...
                            for(x in split(data_copy@data, by="batch_id")){
                              ...
                              for(feature in familiar:::get_feature_columns(data_copy)){
                                ...
                                if(feature_info_list[[feature]]@feature_type == "numeric"){
                                  ...
                                  if(batch_normalisation_method %in% familiar:::.get_available_batch_normalisation_methods("normalisation")){
                                    ...
                                    # Check that the feature is correctly
                                    # centred around 0, but with wider margins
                                    # for the non-parametric method Check also
                                  ...
                                  # Test that the container method matches the
                          ...
                          for(batch_norm_parameters in aggr_batch_normalisation_parameters@batch_parameters){
                            ...
                            if(n_numeric_features > 0 & batch_normalisation_method != "none"){
                              ...
                              if(n_numeric_features <= 2 & batch_normalisation_method %in% familiar:::.get_available_batch_normalisation_methods("combat")){
                                testthat::expect_s4_class(batch_norm_parameters, "featureInfoParametersNormalisationStandardisation")
                                
                              } else {
                                testthat::expect_equal(batch_norm_parameters@method, batch_normalisation_method)
                              }
                              ...
                              # Assert that for the categorical features, the
                              # none method is used.
                              testthat::expect_s4_class(batch_norm_parameters, "featureInfoParametersNormalisationNone")
                            }
                          }
                        })
  }
  ...
  for(batch_normalisation_method in familiar:::.get_available_batch_normalisation_methods()){
    ...
    testthat::test_that(paste0("Batch normalisation is correctly performed using the ",
                               ...
                               n_numeric_features,  " numeric features for a dataset with some NA data."),
                        {
                          ...
                          # Test whether the features are normalised (unless
                          # none).
                          if(batch_normalisation_method == "none"){
                            # Check that the data is not altered.
                            testthat::expect_equal(data.table::fsetequal(data_copy@data, data@data), TRUE)
                          ...
                          for(x in split(data_copy@data, by="batch_id")){
                            ...
                            for(feature in familiar:::get_feature_columns(data_copy)){
                              ...
                              if(feature == "feature_1" && current_batch_id == "1"){
                                ...
                                # Check that the normalisation object is not
                                # none.
                                testthat::expect_equal(is(feature_info_list[[feature]]@batch_normalisation_parameters@batch_parameters[[current_batch_id]],
                                                          "featureInfoParametersNormalisationNone"),
                                                       FALSE)
                                
                                # Check that the normalisation object is complete.
                                testthat::expect_equal(familiar:::feature_info_complete(feature_info_list[[feature]]@batch_normalisation_parameters@batch_parameters[[current_batch_id]]),
                                                       TRUE)
