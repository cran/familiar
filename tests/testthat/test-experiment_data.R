...
testthat::test_that("Assert that data assignment performs correctly", {
  testthat::expect_false(is.null(experiment_data_assignment@experiment_setup))
  testthat::expect_false(is.null(experiment_data_assignment@iteration_list))
  testthat::expect_true(is.null(experiment_data_assignment@feature_info))
  testthat::expect_true(is.null(experiment_data_assignment@vimp_table_list))
})
...
testthat::test_that("Assert that feature info computation performs correctly", {
  # Check that 4 subsets are present, namely generic + complete
  testthat::expect_equal(length(experiment_feature_info@feature_info), 4L)
  
  # Check that there are 6 features.
  testthat::expect_equal(length(experiment_feature_info@feature_info$generic), 6L)
  ...
  # Test contents.
  testthat::expect_true(is.null(experiment_feature_info@vimp_table_list))
  testthat::expect_equal(
