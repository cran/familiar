...
familiar:::test_all_learners_available(learners=familiar:::.get_available_xgboost_tree_learners(show_general=TRUE))
...
familiar:::test_all_learners_parallel_train_predict_vimp(learners=familiar:::.get_available_xgboost_tree_learners(show_general=FALSE),
                                                         hyperparameter_list=list("count"=list("n_boost" = 2,
                                                                                               "learning_rate" = -1,
                                                                                               "lambda" = 0.0,
                                                                                               "alpha" =-6.0,
