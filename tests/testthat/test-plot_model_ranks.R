...
familiar:::test_plot_ordering(plot_function=familiar:::plot_model_signature_occurrence,
                              data_element="model_vimp",
                              outcome_type_available=c("count", "continuous", "binomial", "multinomial", "survival"),
                              debug=debug_flag)
...
# Test alignment of different plots, with missing data.
familiar:::test_plot_ordering(plot_function=familiar:::plot_model_signature_variable_importance,
                              data_element="model_vimp",
                              outcome_type_available=c("count", "continuous", "binomial", "multinomial", "survival"),
                              debug=debug_flag)
