...
names(x_sequential_named) <- letters[1:length(x_sequential_named)]
...
names(x_parallel_named) <- letters[1:length(x_parallel_named)]
...
testthat::test_that("fam_sapply works correctly.", {
  ...
  x <- familiar:::fam_sapply_lb(cl=cl,
                                assign=NULL,
                                X=x_sequential,
                                FUN=apply_vector_fun)
...
testthat::test_that("fam_lapply works correctly.", {
  ...
  x <- familiar:::fam_lapply_lb(cl=cl,
                                assign=NULL,
                                X=x_sequential,
                                FUN=apply_list_fun)
...
testthat::test_that("fam_mapply works correctly.", {
  ...
  x <- familiar:::fam_mapply_lb(cl=cl,
                                assign=NULL,
                                FUN=apply_list_fun_2,
                                x=x_sequential,
                                y=seq_along(x_sequential))
