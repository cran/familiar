...
##### initialize ---------------------------------------------------------------
setMethod("initialize", signature(.Object="familiarHyperparameterLearnerBART"),
          function(.Object, ...){
...
##### get_prediction_type ------------------------------------------------------
setMethod("get_prediction_type", signature(object="familiarHyperparameterLearnerBART"),
          function(object, ...){
...
##### ..train ------------------------------------------------------------------
setMethod("..train", signature(object="familiarHyperparameterLearnerBART", data="data.table"),
          function(object, data, ...){
            ...
            if(length(hyperparameter_names) == 0) return(callNextMethod())
...
##### ..predict ----------------------------------------------------------------
setMethod("..predict", signature(object="familiarHyperparameterLearnerBART", data="data.table"),
          function(object, data, type="default", percentile=NULL, ...){
            ...
            # Encode categorical variables.
            x_encoded <- encode_categorical_variables(data=data,
                                                      object=NULL,
                                                      encoding_method="dummy",
            ...
            if(type == "default"){
              ...
              score_percentile <- apply(predicted_scores, MARGIN=2, stats::quantile, probs=percentile, names=FALSE)
              ...
              ..error_reached_unreachable_code(paste0("..predict,familiarHyperparameterLearnerBART,data.table: ",
