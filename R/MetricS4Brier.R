...
setClass("familiarMetricBrier",
         contains="familiarMetric",
         prototype=methods::prototype(metric = "brier",
...
.get_available_brier_metrics <- function() return(c("brier"))



#####is_available#####
setMethod("is_available", signature(object="familiarMetricBrier"),
          function(object, ...){
...
setMethod("compute_metric_score", signature(metric="familiarMetricBrier"),
          function(metric, data, ...){
            ...
            for(ii in seq_along(outcome_classes)){
              ...
              # Calculate uncorrected brier score for the current positive
              # class.
            ...
            # Correct score for binomial and multinomial outcomes so that it
