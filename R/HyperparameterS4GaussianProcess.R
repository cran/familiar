...
##### initialize ---------------------------------------------------------------
setMethod("initialize", signature(.Object="familiarHyperparameterLearnerLAGP"),
          function(.Object, ...){
...
##### get_prediction_type ------------------------------------------------------
setMethod("get_prediction_type", signature(object="familiarHyperparameterLearnerLAGP"),
          function(object, ...){
            return(c("default", "sd"))
          })
...
##### ..train ------------------------------------------------------------------
setMethod("..train", signature(object="familiarHyperparameterLearnerLAGP", data="data.table"),
...
setMethod("..predict", signature(object="familiarHyperparameterLearnerLAGP", data="data.table"),
          function(object, data, type="default", ...){
            ...
            quiet(predicted_scores <- laGP::aGP(X=object@model$X,
                                                Z=object@model$Z,
            ...
            if(type == "default"){
              ...
              ..error_reached_unreachable_code(paste0("..predict,familiarHyperparameterLearnerLAGP,data.table: ",
...
setMethod("has_bad_training_data", signature(object="familiarHyperparameterLearnerLAGP", data="data.table"),
          function(object, data, ...){
