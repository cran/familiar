...
# Call familiar to create models. Note that we skip hyperparameter optimisation
# by manually defining the hyperparameters, and that we skip evaluation steps.
# This is to save time when creating the vignette.
...
model_directory_path <- file.path(
  tempdir(), "binomial", "trained_models", "random_forest_ranger", "none")
model_path <- file.path(
  model_directory_path,
  list.files(model_directory_path, pattern = "model")[1])
...
# Create path to the directory containing the models.
model_directory_path <- file.path(
  tempdir(), "survival", "trained_models", "random_forest_ranger", "none")
model_path <- file.path(
  model_directory_path, 
  list.files(model_directory_path, pattern = "model")[1])
...
<img src="eval_and_explain/model-performance-plot-1.png" alt="plot of chunk model-performance-plot"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/auc-roc-curve-bci-1.png" alt="plot of chunk auc-roc-curve-bci"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/auc-roc-curve-point-1.png" alt="plot of chunk auc-roc-curve-point"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/auc-pr-curve-bci-1.png" alt="plot of chunk auc-pr-curve-bci"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/auc-pr-curve-point-1.png" alt="plot of chunk auc-pr-curve-point"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/confusion-matrix-1.png" alt="plot of chunk confusion-matrix"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/kaplan-meier-plot-1.png" alt="plot of chunk kaplan-meier-plot"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/calibration-data-bci-1.png" alt="plot of chunk calibration-data-bci"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/calibration-data-point-1.png" alt="plot of chunk calibration-data-point"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/decision-curve-bci-1.png" alt="plot of chunk decision-curve-bci"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/model-variable-importance-1.png" alt="plot of chunk model-variable-importance"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/permutation-variable-importance-bc-1.png" alt="plot of chunk permutation-variable-importance-bc"  />
</div>
...
#> Error in ..error_value_outside_allowed_range(x = x, var_name = var_name, : feature_similarity_threshold is expected to have a value between -1 and 0. Found: 0.6

plots[[1]]
```

<div class="figure" style="text-align: center">
<img src="eval_and_explain/permutation-variable-importance-bc-spearman-1.png" alt="plot of chunk permutation-variable-importance-bc-spearman"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-cell-shap-uniformity-1.png" alt="plot of chunk ice-cell-shap-uniformity"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-cell-shape-uniformity-anchored-1.png" alt="plot of chunk ice-cell-shape-uniformity-anchored"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-2d-1.png" alt="plot of chunk ice-2d"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-2d-anchored-1.png" alt="plot of chunk ice-2d-anchored"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-2d-survival-1.png" alt="plot of chunk ice-2d-survival"  />
</div>
...
plots <- familiar::plot_feature_similarity(
  ...
  data = binomial_data,
  feature_similarity_metric = "spearman")
#> Error in ..error_value_outside_allowed_range(x = x, var_name = var_name, : feature_similarity_threshold is expected to have a value between -1 and 0. Found: 0.3
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/feature-similarity-1.png" alt="plot of chunk feature-similarity"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/sample-similarity-1.png" alt="plot of chunk sample-similarity"  />
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/sample-similarity-unnormalised-1.png" alt="plot of chunk sample-similarity-unnormalised"  />
</div>
