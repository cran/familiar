...
against a threshold. The receiver-operating curve is created by iterating over
...
The implementation in `familiar` does not directly use the ROC curve to compute the AUC.
...
i.e. one-versus-all, and averaged [@Hand2001-ij].
...
A contingency table or confusion matrix shows observed and predicted
...
example, winsorised and trimmed versions of the mean squared error metric are
