...
<img src="eval_and_explain/model-performance-plot-1.png" alt="Performance of the ischemic stroke model on hold-out test data.
...
<p class="caption">Performance of the ischemic stroke model on hold-out test data.
 The model is a classifier, and was assessed using three metrics:
 area under the receiver-operating characteristic curve (AUC), the Brier 
 score, and the F1-score. Higher AUC and F1-scores, and lower Brier score, 
 indicate better models. The graph shows the distribution of performance 
 metrics obtained from bootstraps of the dataset, along with 2.5th, 50.0th
 and 97.5th percentiles.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/model-performance-plot-standalone-1.png" alt="Performance for the ischemic strok model obtained using a 
  prediction table. This results in the same figure as above, obtained
  using the model itself."  />
<p class="caption">Performance for the ischemic strok model obtained using a 
  prediction table. This results in the same figure as above, obtained
  using the model itself.</p>
</div>
...
#> 1: 160500_Iz4qsMafAmSfqv4Mm7ZA        none random_forest_ranger_default      ensemble.NA.NA      auc 0.7387626 0.5166193 0.9146674
#> 2: 160500_Iz4qsMafAmSfqv4Mm7ZA        none random_forest_ranger_default      ensemble.NA.NA    brier 0.2041370 0.1639073 0.2492457
#> 3: 160500_Iz4qsMafAmSfqv4Mm7ZA        none random_forest_ranger_default      ensemble.NA.NA f1_score 0.7407407 0.5152258 0.8967186
```
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/auc-roc-curve-bci-1.png" alt="Receiver-operating characteristic curve for the ischemic stroke 
 model on hold-out test data. The 95% confidence interval is shown (grey)."  />
<p class="caption">Receiver-operating characteristic curve for the ischemic stroke 
 model on hold-out test data. The 95% confidence interval is shown (grey).</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/auc-roc-curve-point-1.png" alt="Receiver-operating characteristic curve for the ischemic stroke 
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/auc-pr-curve-bci-1.png" alt="Precision-recall curve for the ischemic stroke model on hold-out 
test data. The 95% confidence interval is shown (grey)."  />
<p class="caption">Precision-recall curve for the ischemic stroke model on hold-out 
test data. The 95% confidence interval is shown (grey).</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/auc-pr-curve-point-1.png" alt="Precision-recall curve for the ischemic stroke 
 model on hold-out test data. Whereas the previous figure shows the bootstrap
 estimate and confidence interval, the current curve is formed
 directly from the data."  />
<p class="caption">Precision-recall curve for the ischemic stroke 
 model on hold-out test data. Whereas the previous figure shows the bootstrap
 estimate and confidence interval, the current curve is formed
 directly from the data.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/confusion-matrix-1.png" alt="Confusion matrix for the ischemic stroke 
...
<p class="caption">Confusion matrix for the ischemic stroke 
 model on hold-out test data. The number of instances with the prediction
 of ischemic stroke (expected sroke), and actually observed stroke, is shown.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/kaplan-meier-plot-1.png" alt="Kaplan-Meier plot for the colon cancer survival model on hold-out
...
<p class="caption">Kaplan-Meier plot for the colon cancer survival model on hold-out
 test data. The hold-out test data were split into two risk groups by
 applying a threshold that was defined during training. 95% confidence
 intervals are shown. The number of patients surviving without tumour recurrence
 is shown below the main plot.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/calibration-data-bci-1.png" alt="Calibration plot for the ischemic stroke model on hold-out
...
<p class="caption">Calibration plot for the ischemic stroke model on hold-out
 test data. The plot shows the predicted (expected) probability of ischemic 
 stroke, against the observed occurrence within smaller groupings of data. 
 The plot shows the ideal calibration (dashed line), the linear calibration
 fit (thin line), and estimated calibration (thick line). 95% confidence
 ...
 Calibration outside the main distribution is more uncertain. The inset 
 describes the intercept and slope of the linear fit, and the results
 of the Hosmer-Lemeshow goodness-of-fit test.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/calibration-data-point-1.png" alt="Calibration plot for the ischemic stroke model on hold-out
...
<p class="caption">Calibration plot for the ischemic stroke model on hold-out
 test data. Whereas in the earlier figure the calibration curve was the
 bootstrap estimate, here the expected probability and observed proportions 
 in several (random) groupings is shown.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/decision-curve-bci-1.png" alt="Decision curve for the ischemic stroke model on hold-out
 test data. Three lines are shown. The horizontal line intersecting the origin
 corresponds to no (model-based) intervention, i.e. the status-quo. The
 downward sloping curve corresponds to performing an intervention for everyone.
 The final curve corresponds to model-based intervention, where every patient
 with a predicted probability above the threshold receives the interventional
 treatment. This curve is a bootstrap estimate, and is drawn with 95% 
 confidence intervals. "  />
<p class="caption">Decision curve for the ischemic stroke model on hold-out
 test data. Three lines are shown. The horizontal line intersecting the origin
 corresponds to no (model-based) intervention, i.e. the status-quo. The
 downward sloping curve corresponds to performing an intervention for everyone.
 The final curve corresponds to model-based intervention, where every patient
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/model-variable-importance-1.png" alt="Variable importance plot for the ischemic stroke model on hold-out
 test data. Features are sorted from highest to least importance. Features 
 with letters indicate features that are highly similar, and could be 
 clustered together. Note that because of the permutation variable 
 importance method used within the random forest, such features do not 
 receive the same score."  />
<p class="caption">Variable importance plot for the ischemic stroke model on hold-out
 test data. Features are sorted from highest to least importance. Features 
 with letters indicate features that are highly similar, and could be 
 clustered together. Note that because of the permutation variable 
 importance method used within the random forest, such features do not 
 receive the same score.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/permutation-variable-importance-bc-1.png" alt="Permutation variable importance plot for the ischemic stroke model on hold-out
...
<p class="caption">Permutation variable importance plot for the ischemic stroke model on hold-out
 test data. Features are sorted from highest (top) to least importance (bottom).
 Permutation variable importance measures the model performance difference 
 between normal and shuffled (informationless) input values for each feature.
 At the threshold of 1.00 every feature is shuffled individually, whereas at 0.23
 groups of similar features are shuffled simultaneously.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_summary-1.png" alt="SHAP summary plot for the ischemic stroke model on hold-out
 test data. Features are sorted from highest (top) to least importance (bottom),
...
<p class="caption">SHAP summary plot for the ischemic stroke model on hold-out
 test data. Features are sorted from highest (top) to least importance (bottom),
 based on SHAP values. Each point represents the marginal contribution 
 of a feature value to the predicted probability of the model, and is coloured
 according to its (normalised) feature value.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_summary_violin-1.png" alt="SHAP summary plot for the ischemic stroke model on hold-out
 test data. Features are sorted from highest (top) to least importance (bottom),
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_summary_bar-1.png" alt="SHAP summary plot for the ischemic stroke model on hold-out
 test data. Features are sorted from highest (top) to least importance (bottom),
 based on the mean of the absolute SHAP values in the underlying data."  />
<p class="caption">SHAP summary plot for the ischemic stroke model on hold-out
 test data. Features are sorted from highest (top) to least importance (bottom),
 based on the mean of the absolute SHAP values in the underlying data.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-max-remodeling-ratio-1.png" alt="Individual conditional expectation plot for the max_remodeling_ratio feature
...
<p class="caption">Individual conditional expectation plot for the max_remodeling_ratio feature
 in the ischemic stroke model using instances from the hold-out test data. 
 Each curve follows the predicted probability for an instance where only
 the value of the max_remodeling_ratio is changed. The thick line corresponds to
 the average of all individual curves, i.e. partial dependence. High novelty scores
 signify values that are more likely to be outliers.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-max-remodeling-ratio-anchored-1.png" alt="Individual conditional expectation plot for the max_remodeling_ratio feature
 in the ischemic stroke model using instances from the hold-out test data. 
 Each curve follows the predicted probability for an instance where only
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-2d-1.png" alt="Partial depence plot for the max_remodeling_ratio and coronary_artery_disease
...
<p class="caption">Partial depence plot for the max_remodeling_ratio and coronary_artery_disease
 features in the ischemic stroke model using instances from the hold-out test data. 
 Individual curves are not shown for 2D plots. High novelty scores,
 indicated by smaller points, signify values that are more likely to be outliers.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-2d-anchored-1.png" alt="Partial depence plot for the max_remodeling_ratio and coronary_artery_disease
 features in the ischemic stroke model using instances from the hold-out test data.
...
<p class="caption">Partial depence plot for the max_remodeling_ratio and coronary_artery_disease
 ...
 Without novelty, elements are shown as rectangles to better show probability.
 Moreover, probabilities were anchored at max_remodeling_ratio = 2.5, and
 coronary_artery_disease = no. Individual curves are not shown for 2D plots.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap-dependence-1.png" alt="SHAP dependence plot for the max_remodeling_ratio feature
 in the ischemic stroke model using instances from the hold-out test data."  />
<p class="caption">SHAP dependence plot for the max_remodeling_ratio feature
 in the ischemic stroke model using instances from the hold-out test data.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap-dependence-interaction-1.png" alt="SHAP dependence plot for the max_remodeling_ratio feature
 in the ischemic stroke model using instances from the hold-out test data.
 Each point shows the corresponding value for coronary_artery_disease."  />
<p class="caption">SHAP dependence plot for the max_remodeling_ratio feature
 in the ischemic stroke model using instances from the hold-out test data.
 Each point shows the corresponding value for coronary_artery_disease.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap-dependence_interaction_2-1.png" alt="SHAP dependence plot for the max_remodeling_ratio feature
 in the ischemic stroke model using instances from the hold-out test data.
 Each point shows the corresponding value for max_dilation_by_area."  />
<p class="caption">SHAP dependence plot for the max_remodeling_ratio feature
 in the ischemic stroke model using instances from the hold-out test data.
 Each point shows the corresponding value for max_dilation_by_area.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_force_plot-1.png" alt="SHAP force plot for the ischemic stroke model using all instances
 from the hold-out test data. The force plot show the stacked positive and 
 negative marginal contributions for all features."  />
<p class="caption">SHAP force plot for the ischemic stroke model using all instances
 from the hold-out test data. The force plot show the stacked positive and 
 negative marginal contributions for all features.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_force_plot_highlight-1.png" alt="SHAP force plot for the ischemic stroke model using all instances
 from the hold-out test data. The force plot show the stacked positive and 
...
<p class="caption">SHAP force plot for the ischemic stroke model using all instances
 from the hold-out test data. The force plot show the stacked positive and 
 negative marginal contributions for all features. The contributions by
 the max_remodeling_ratio feature are highlighted.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_waterfall-1.png" alt="SHAP waterfall plot for the ischemic stroke model for a single sample
...
<p class="caption">SHAP waterfall plot for the ischemic stroke model for a single sample
 from the hold-out test data. The waterfall plot shows the marginal
 contributions of each feature for a sample. Features with the largest
 contributions are shown at the top.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/feature-similarity-1.png" alt="Feature similarity heatmap for features used in the ischemic
...
<p class="caption">Feature similarity heatmap for features used in the ischemic
 stroke model. Similarity is computed using Spearman's rank correlation
 coefficient. Features are clustered by similarity, with strongly (anti-)correlated
 features being grouped together more closely.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/sample-similarity-1.png" alt="Sample similarity heatmap of samples in the hold-out test set based on 
...
<p class="caption">Sample similarity heatmap of samples in the hold-out test set based on 
 features used in the ischemic stroke model. Similarity between features is
 computed using Spearman's rank correlation coefficient, whereas similarity
 between samples is computed using Gower's distance. Strongly (anti-)correlated
 features and samples being grouped together more closely, respectively.
 Feature values are normalised.</p>
</div>
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/sample-similarity-unnormalised-1.png" alt="Sample similarity heatmap of samples in the hold-out test set based on 
 features used in the ischemic stroke model. Similarity between features is
 computed using Spearman's rank correlation coefficient, whereas similarity
 between samples is computed using Gower's distance. Strongly (anti-)correlated
 features and samples being grouped together more closely, respectively.
